...
module Text.XML.HXT.Monad.DTDValidation.Validation
    ( getDTDSubset
...
import qualified Text.XML.HXT.Monad.DTDValidation.DocTransformation as DocTransformation
import qualified Text.XML.HXT.Monad.DTDValidation.DocValidation     as DocValidation
import qualified Text.XML.HXT.Monad.DTDValidation.DTDValidation     as DTDValidation
import qualified Text.XML.HXT.Monad.DTDValidation.IdValidation      as IdValidation
