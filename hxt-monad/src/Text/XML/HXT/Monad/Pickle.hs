...
module Text.XML.HXT.Monad.Pickle
    ( xpickleDocument            -- from this module Text.XML.HXT.Monad.Pickle
    , xunpickleDocument
    , xpickleWriteDTD
    , xpickleDTD
    , checkPickler
    ...
    , a_addDTD
      ...
      -- from Text.XML.HXT.Monad.Pickle.Xml
    , pickleDoc
    , unpickleDoc
    , unpickleDoc'
    , showPickled
    ...
    , xpZero
      ...
      -- from Text.XML.HXT.Monad.Pickle.Schema
    , Schema
    , Schemas
    , DataTypeDescr
    )
...
import           Text.XML.HXT.Monad.Pickle.Xml
...
-- 'Text.XML.HXT.Monad.writeDocument'. The option list is passed to 'Text.XML.HXT.Monad.writeDocument'
--
...
--
-- The document is read with 'Text.XML.HXT.Monad.readDocument'. Options are passed
-- to 'Text.XML.HXT.Monad.readDocument'. The conversion from XmlTree is done with the
-- pickler.
--
