...
import           Text.XML.HXT.Monad.DocumentOutput           (encodeDocument,
                                                              encodeDocument',
                                                              putXmlDocument)
import           Text.XML.HXT.Monad.Edit                     (addDefaultDTDecl, haskellRepOfXmlDoc,
                                                              indentDoc, preventEmptyElements, removeDocWhiteSpace,
                                                              treeRepOfXmlDoc)
import           Text.XML.HXT.Monad.XmlState
import           Text.XML.HXT.Monad.XmlState.RunIOStateArrow (initialSysState)
...
this filter can be configured by an option list like 'Text.XML.HXT.Monad.ReadDocument.readDocument'

usage: @ writeDocument optionList destination @

if @ destination @ is the empty string or \"-\", stdout is used as output device

for available options see 'Text.XML.HXT.Monad.XmlState.SystemConfig'
...
-- The default may be overwritten with the 'Text.XML.HXT.Monad.XmlState.SystemConfig.withOutputEncoding' option.
