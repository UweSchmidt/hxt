...
-- this parser is an extension of the monadic parser above.
-- It maintains an additional name table for element and attribute names
-- to share these names in the generated tree.
